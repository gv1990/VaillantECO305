...
Version 0.6 ist ein **rein passiver** Decoder für Vaillant-eBUS-Telegramme,
...
Version 0.6 enthält absichtlich **keinen** Aufruf von `SendDataToParent()`.
Kompressordaten werden nur ausgewertet, wenn sie bereits auf dem Bus vorhanden
sind.

Die Heizkurve wird in Version 0.6 nur gelesen. Eine spätere Schreibfunktion
...
Archiveinträge erzeugen würden. Version 0.6 zeigt zusätzlich das zuletzt
